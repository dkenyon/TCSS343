...
//		printArrayToConsole(theArray);
	...
	/* **********************************************************************************************************************************************
	 * 							ALGORITHM METHODS - THESE ARE THE DYNAMIC PROGRAMMING, DIVIDE-AND-CONQUER, AND BRUTE FORCE METHODS
	 * 
	 * *********************************************************************************************************************************************
	 */
...
//    	System.out.println(" ("+ 0 + ", " + 4 +") ");
	...
	/* **********************************************************************************************************************************************
	 * 							LOGISTICAL METHODS - THESE METHODS WERE USED TO CREATE OUR INPUT FILES AND HELP DEBUG
	 * 
	 * *********************************************************************************************************************************************
	 */
